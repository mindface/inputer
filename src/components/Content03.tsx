  ...
  return (
   <div className="content p-10 boxShadow">
     ...
     <div className='box p-3'>
       <Button variant="outlined" onClick={handleClickOpen}>Open List</Button>
       検索情報を変更するため、選んでください。</div>
     {selectData && <div className='box p-2'>
       <h4 className="title pb-1 mb-1 border-b">ラベル | {selectData.card04_category}</h4>
            ...
            <ListItem key={index}>
              <div className='box w-100'>
                <Grid container spacing={1}>
                  <Grid item>
                  <h4 className="title pb-1 mb-1 border-b">ラベル | {item.card04_category}</h4>
                  </Grid>
                  <Grid item>
                    <Button variant="outlined" onClick={() => selectInfo(item)}>select</Button>
                  </Grid>
                </Grid>
              </div>
            </ListItem>)

...
function FlowSection(){
  ...
  const phaseBase = ['フェーズ 01','フェーズ 02','フェーズ 03','フェーズ 04','フェーズ 05','フェーズ 06','フェーズ 07','フェーズ 08'];
   ...
   <section className="section p-10 boxShadow">
    ...
    <Box width={350}>
      ...
      <Slider
        ...
        value={abr01}
        onChange={(e:Event,r:(number | number[])) => {abr01Set(r as number)}}
      />
      {abr01}
      ...
      <Slider
        ...
        valueLabelDisplay="auto"
        value={abr02}
        onChange={(e:Event,r:(number | number[])) => {abr02Set(r as number)}}
      />
      ...
      <Slider
        ...
        valueLabelDisplay="auto"
        value={abr03}
        onChange={(e:Event,r:(number | number[])) => {abr03Set(r as number)}}
      />
      ...
      <Slider
        ...
        valueLabelDisplay="auto"
        value={abr04}
        onChange={(e:Event,r:(number | number[])) => {abr04Set(r as number)}}
      />
    </Box>
   </section>
  )

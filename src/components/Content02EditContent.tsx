      ...
      >
        ...
        <AccordionDetails>
          <div className="card02">
            ...
            <p className="caption">
              基礎体力の結果 (運動) | 記憶力のテスト [{editInfo.card02_value1}%]
            </p>
            <Slider
              getAriaLabel={() => "Minimum distance"}
            ...
            />
            <p className="caption">
              練習で計画をベース成長可能% [{editInfo.card02_value2[0]}% -{" "}
      ...
      >
        ...
        <AccordionDetails>
          <div className="card03">
            ...
            <p className="caption">
              1日単位で使える時間 [{editInfo.card03_value1}]時間
            </p>
            <Slider
              getAriaLabel={() => "Minimum distance"}
            ...
            />
            <p className="caption">
              ツールやフィードバックされる回数 [{editInfo.card03_value2}]
            </p>
            <Slider
              getAriaLabel={() => "Minimum distance"}
            ...
            />
            <p className="caption">
              これまでに使った日数 [{editInfo.card03_value3}]
            </p>
            <Slider
              getAriaLabel={() => "Minimum distance"}
      ...
      >
        ...
        <AccordionDetails>
          <div className="card06">
            ...
            />
            <p className="caption">
              自分以外のパフォーマンスに対して、言葉上での自分の行動に発生するズレ
            </p>
